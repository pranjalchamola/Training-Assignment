   ...
   var namedatay;
                var index=0;
                namedatax = docGG.doctorListing[index].docName;
                document.getElementById("demo1").innerHTML = namedatax;
                namedatax = docGG.doctorListing[index].address[index].addressLineTwo+','+docGG.doctorListing[index].address[index].city+','+ docGG.doctorListing[index].address[index].state;
                document.getElementById("demo2").innerHTML = namedatax;
                namedatax = docGG.doctorListing[index].address[index].addressLineOne;
                document.getElementById("demo3").innerHTML = namedatax;
 ...
 document.getElementById("hideapp").style.display='block';
    ...
    function forceG4()
    {
     ...
     function load() {
                     ...
                     var namedatax;
                     namedatax= doc.docName[0];
                     document.getElementById("docL").innerHTML = namedatax;
